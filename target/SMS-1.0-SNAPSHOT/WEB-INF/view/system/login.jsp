    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#submitBtn").click(function () {
                ...
                } else if ($('#verificationCodeCode').val() === '') {
    ...
    <div id="loginform" class="loginBox">
        <form id="form" class="form form-horizontal" method="post" action="#">
            ...
            <div class="row cl">
                <label class="form-label col-3"><i class="Hui-iconfont">&#xe647;</i></label>
                <div class="formControls col-8">
                    <input id="verificationCode" class="input-text radius size-L" name="verificationCode" type="text"
                           placeholder="验证码"
                           style="width: 200px;">
                    <img title="点击图片切换验证码哟 ~" id="vcodeImg" src="getVerificationCodeImage" alt="#">
                </div>
            </div>
            <!-- 用户类型 -->
