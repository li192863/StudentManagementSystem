        ...
        $(function () {
            ...
            $('#dataList').datagrid({
                ...
                columns: [[
                    ...
                    {field: 'introduction', title: '班级介绍', width: 220}
                ]],
                toolbar: "#toolbar"//工具栏
            });
            ...
            $("#editDialog").dialog({
                ...
                onBeforeOpen: function () {
                    ...
                    $("#edit_gradeName").textbox('setValue', selectRow.gradeName);
    ...
    <form id="addForm" method="post" action="#">
        <table id="addTable" style="border-collapse:separate; border-spacing:0 3px;" cellpadding="6">
            ...
            <tr>
                <td>所属年级</td>
                <td colspan="1">
                    <select id="add_gradeName" style="width: 200px; height: 30px;" class="easyui-combobox"
                            name="gradeName">
                        <c:forEach items="${gradeList}" var="grade">
                            <option value="${grade.name}">${grade.name}</option>
                        </c:forEach>
    ...
    <form id="editForm" method="post" action="#">
        ...
        <table id="editTable" style="border-collapse:separate; border-spacing:0 3px;" cellpadding="6">
            ...
            <tr>
                <td>所属年级</td>
                <td colspan="1">
                    <select id="edit_gradeName" style="width: 200px; height: 30px;" class="easyui-combobox"
                            name="gradeName">
                        <c:forEach items="${gradeList}" var="grade">
                            <option value="${grade.name}">${grade.name}</option>
                        </c:forEach>
